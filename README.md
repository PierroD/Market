...
# Market (latest update 11/02/2023)
...
- [Download the lastest version](https://raw.githubusercontent.com/PierroD/Market/main/_updates/Market%20v2.2.4.zip) - (check if some updates are needed)
