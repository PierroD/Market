...
# Market (latest update 10/24/2023)
...
- [Download the lastest version](https://raw.githubusercontent.com/PierroD/Market/main/_updates/Market%20v2.1.3.zip) - (check if some updates are needed)
